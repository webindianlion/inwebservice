...
<body class="home">
   ...
   <?php include './common/topmenu.php' ?>
    ...
    <section class="container whyWebsite ">
        <h3 class="ttl">Why a Business need a website</h3>
        <p  class="subTtl">All you need to know the necessity of a websites</p>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-sm-6 col-lg-4 cardd"  data-aos="fade-up"> 
                    <p> <i class="fas fa-dollar-sign"></i> Your business brand credibility is proven by your business website. </p>  
                </div>
                <div class="col-12 col-sm-6 col-lg-4 cardd"  data-aos="fade-up"> 
                    <p> <i class="fas fa-certificate"></i> Your business brand are Easily Accessible with business website.</p>   
                </div>
